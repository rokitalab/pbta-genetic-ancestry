...
summary(readRDS(file.path(results_dir, "coxph_braf_efs_add_resection_breakpoint_group.RDS")))
...
```{r}
braf_model_efs <- fit_save_model(braf_hist[braf_hist$extent_of_tumor_resection != "Not Reported",],
                                    terms = "extent_of_tumor_resection+breakpoint_group+age_at_diagnosis_years",
               file.path(results_dir, "coxph_braf_efs_add_resection_breakpoint_group_age.RDS"),
               "multivariate",
               years_col = "EFS_years", status_col = "EFS_status"
              )

summary(readRDS(file.path(results_dir, "coxph_braf_efs_add_resection_breakpoint_group_age.RDS")))

plotForest(readRDS(file.path(results_dir, "coxph_braf_efs_add_resection_breakpoint_group_age.RDS")))

ggsave(file.path(plot_dir, "pbta_ancestry_forest_efs_add_resection_breakpoint_group_age.pdf"),
       width = 8, height = 3)
```
