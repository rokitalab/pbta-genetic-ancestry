...
hist_tumor <- hist %>%
  filter(sample_type != 'Normal',
         ...
         # removed derived cell lines, but keep for pt ids PT_40N7BXSQ and PT_EVQZ62SE since only tumors available
         (composition != "Derived Cell Line" | Kids_First_Participant_ID %in% c("PT_40N7BXSQ", "PT_EVQZ62SE"))) %>%
